...
public class ImageProcessorDecreaseImpl extends UnicastRemoteObject implements ImageProcessorDecrease {

    private String osName;
    private String cpuUsage;
    private String ramUsage;

    public ImageProcessorDecreaseImpl() throws RemoteException {
        super();
    }
    ...
    public Image processImage(byte[] imageData, int zoomParameters) throws RemoteException {
        try {
            ...
            throw new RemoteException("Error resizing image in C04." + e.getMessage());
        }
    }
